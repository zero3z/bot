module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if (!giveaway) return client.deleteMsg(message, `${client.e.error} Không thể tìm thấy giveaway nào hoặc giveaway chưa đã kết thúc, vui lòng thử lại sau!`, 5000, "reply")
