...
module.exports = {
  ...
  async execute(client, message, args) {
   const channel = message.member.voice.channel
    if (!channel) {
      return client.deleteMsg(message, `${client.e.error} Vào voice để sử dụng lệnh `, 5000, "reply");
    }
    ...
    if (message.guild.members.me.voice.channel) {
      ...
      return client.deleteMsg(message, `${client.e.error} Bot đã ở trong voice`, 5000, "reply");
    }
